		...
		<div class="mx-auto max-w-7xl py-6 sm:py-6 lg:px-8">
			...
			<form method="POST" action="/notes">
				...
				<div class="col-6">
					...
					<div class="mt-2">
						<textarea id="body" name="body" rows="3" cols="50" class="block rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300"><?= $_POST['body'] ?? '' ?></textarea>
